...
public class Browser_4 extends AppCompatActivity implements ObservableScrollViewCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = Browser_4.this;

        getWindow().addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        getWindow().setStatusBarColor(ContextCompat.getColor(activity, R.color.colorPrimaryDark_4));
        ...
        toolbar.setBackgroundColor(ContextCompat.getColor(activity, R.color.colorPrimary_4));
