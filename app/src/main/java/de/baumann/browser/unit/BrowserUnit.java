...
public class BrowserUnit {
    ...
    public static boolean isURL(String url) {
        ...
        boolean isMatch = pattern.matcher(url).matches();
    ...
    public static String queryWrapper(Context context, String query) {
        ...
        final int i = Integer.valueOf(Objects.requireNonNull(sp.getString(context.getString(R.string.sp_search_engine), "4")));
        switch (i) {
            case 0:
