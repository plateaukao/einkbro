...
public class Database_Bookmarks extends SQLiteOpenHelper {
    public Database_Bookmarks(Context context)
    ...
    public void loadInitialData() {
        ...
        stmt.bindString(2, "Default entry - Browser_left on Github");
    ...
    public void getBookmarks(ArrayList<String[]> data, Context context) {
        ...
        if (sp.getString("sortBO", "title").equals("title")) {
            ...
            c.close();
            db.close();
        } else if (sp.getString("sortBO", "title").equals("seqno")) {
