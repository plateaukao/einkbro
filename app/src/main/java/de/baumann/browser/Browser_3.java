...
public class Browser_3 extends AppCompatActivity implements ObservableScrollViewCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = Browser_3.this;

        getWindow().addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        getWindow().setStatusBarColor(ContextCompat.getColor(activity, R.color.colorPrimaryDark_3));
        ...
        toolbar.setBackgroundColor(ContextCompat.getColor(activity, R.color.colorPrimary_3));
    ...
    private class myWebChromeClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int progress) {
            ...
            if (progress == 100) {
                sharedPref.edit().putString("tab_3", helper_webView.getTitle(activity, mWebView)).apply();
